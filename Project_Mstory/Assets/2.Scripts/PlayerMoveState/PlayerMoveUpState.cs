...
{
    public PlayerMoveUpState(Player player, Animator animator, BoxCollider2D attackCollider) : base(player, animator, attackCollider)
    {
        mDirectionKey = "Back";
    }
    ...
    {
        mPlayer.SetDirection(Player.EDirection.Back);
